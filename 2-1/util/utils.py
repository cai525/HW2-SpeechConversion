...
def to_var(x, requires_grad=True):
    """ pytorch 的 variable 类型在 0.4.0 中就被取消了，所以理解成 tensor 就行了"""
...
class Hps:
    ...
    超参数信息以json格式存储于文件夹中,而在载入后存在hps属性中，该属性为
    namedtuple函数返回一个特殊的元组，关于该函数请参考
    https://docs.python.org/zh-cn/3.8/library/collections.html#collections.namedtuple
